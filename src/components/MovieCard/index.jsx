        ...
        <Container {...rest}>
            ...
            <div className="description">
                <p>
                    ...
                    Cooper, ex-piloto <br/>da NASA, tem uma fazenda com sua família. Murphy, a filha de dez anos de Cooper, acredita que seu quarto 
...

            {
                ...
                <footer>
                    {
                        data.tags.map( tag => <Tag variant="secondary" key={tag.id} title={tag.name}/> )
                    }
                </footer>
            }
        </Container>
